...
`
	...
	fields = [
		...
		{ key: 'variable_name', type: 'string', label: 'Variable Name: ',
			tooltip: 'an optional channel variable name where the collected digits can be stored',
		},
		{ key: 'digit_timeout', type: 'number', label: 'Digit Timeout (seconds): ',
