		...
		return p.prototype.create = function() {
			...
			e.forEach((e => {
				...
				var o = {
					...
					//|| (( e.getAttribute("value") || e.innerText ) == this.el.value ) // REM HACK: apparently setting el.value and not setting el.options[*].selected is causing problems here
					,
			...
			e.preventDefault() // REM HACK this is to fix a conflict with Aimara's window click handler
