...
def http_did( did: int ) -> Response:
	...
	html_rows.extend( [
		...
		'</td><td>&nbsp;</td><td valign="top">',
		f'<b>Category:</b><br/>',
		'<span class="tooltipped"><select name="category">{"".join(category_options)}</select>',
		...
		'</td><td>&nbsp;</td><td valign="top">',
		f'<b>DID Flag:</b><br/>',
		'<span class="tooltipped"><input type="text" name="flag" value="{html_att(str(flag))}" size="31" maxlength="30"/>',
